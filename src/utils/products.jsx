...
export const SliderData = [
  {
    id: 1,
    title: "Upgrade Your Living Room — 50% Off Sofas",
    desc: "Discover our exclusive selection of modern sofas at half price. Comfort and style delivered to your door.",
    cover: sofaSlide,
  },
  {
    id: 2,
    title: "Latest Smartphones — 50% Off for First Purchase",
    desc: "Experience cutting-edge technology at unbeatable prices. Grab your new phone with a special welcome discount.",
    cover: phone08,
  },
  {
    id: 3,
    title: "Wireless Audio Sale — Up to 50% Off",
    desc: "Immerse yourself in rich, wireless sound. Don’t miss our limited-time deals on headphones and speakers.",
    cover: wireless01,
  },
  {
    id: 4,
    title: "Smart Watches — 50% Off for New Customers",
    desc: "Stay connected in style. Enjoy advanced features and sleek designs at half the price on your first order.",
    cover: watchSlide,
  },
];
